...
// Enables faculty webmasters and researchers to customize, preview, and generate embed code.
...
<style>
    ...
    body.light-mode .form-select-custom, body.light-mode .form-input-custom {
        background: #ffffff;
        border-color: #cbd5e1;
        color: #0f172a;
    }
    ...
    .preview-transparent-bg {
        background: repeating-conic-gradient(#e2e8f0 0% 25%, #ffffff 0% 50%) 50% / 20px 20px !important;
    }
    .code-box {
        background: #0f172a;
        color: #f8fafc;
...
<!-- Hero Section -->
<div class="hero glass-panel animate-fade-in" style="padding: 35px 24px; margin-bottom: 30px; text-align: center;">
    <div style="display: inline-flex; align-items: center; gap: 8px; font-size: 0.82rem; font-weight: 600; color: #10b981; background: rgba(16,185,129,0.1); border: 1px solid rgba(16,185,129,0.25); border-radius: 999px; padding: 5px 16px; margin-bottom: 12px;">
        <i class="fa-solid fa-code"></i> Research Data Embed System
    </div>
    <h2 style="font-size: 1.85rem; font-weight: 700; margin-bottom: 10px; color: var(--color-text-main);">
    ...
    <div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; flex-wrap: wrap; gap: 10px;">
            ...
            <div style="display: flex; gap: 6px; align-items: center;">
                ...
                <button type="button" class="tab-pill active" id="bg-btn-light" onclick="setPreviewBg('light')" style="padding: 4px 10px; font-size: 0.75rem;">ขาว</button>
                <button type="button" class="tab-pill" id="bg-btn-dark" onclick="setPreviewBg('dark')" style="padding: 4px 10px; font-size: 0.75rem;">มืด</button>
            </div>
        </div>
