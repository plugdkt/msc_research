        ...
        <div class="container nav-container">
            ...
            <nav class="admin-nav-menu">
                ...
                <div class="nav-dropdown">
                    <a href="index.php" class="nav-link <?php echo in_array($current_page, ['admin_dashboard', 'admin_researchers', 'admin_publications', 'admin_corresponding', 'admin_users', 'admin_import', 'admin_sync', 'admin_sdgs', 'admin_topics', 'admin_rcr']) ? 'active' : ''; ?>">
